...
// EigenValues.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CEigenValuesApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CEigenValuesApp

CEigenValuesApp::CEigenValuesApp()
{
...
// Единственный объект CEigenValuesApp

CEigenValuesApp theApp;


// Инициализация CEigenValuesApp

BOOL CEigenValuesApp::InitInstance()
{
